...
class SearchMovieControllerTest {
    ...
    @Test
    public void getFilteredMovie_notFound_throwException() throws Exception {
        movieRepository.deleteAll();

        mockMvc.perform(MockMvcRequestBuilders.get("/api/search").param("query", "nothing"))
                .andExpect(MockMvcResultMatchers.status().isNotFound())
                .andExpect(MockMvcResultMatchers.content().string("No movies found matching: nothing"));
